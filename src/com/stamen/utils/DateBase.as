package com.stamen.utils
{
    ...
    {
        public static var dayNamesShort:Array = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'];
        public static var dayNamesLong:Array = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Satday', 'Sunday'];
