package com.nyc.ui {
	 ...
	 * take that!
	 */
    public class MTAMapControls extends Sprite
    {
        public var leftButton:NYCButton = new NYCButton(Button.LEFT);
        public var rightButton:NYCButton = new NYCButton(Button.RIGHT);
        public var upButton:NYCButton = new NYCButton(Button.UP);
        public var downButton:NYCButton = new NYCButton(Button.DOWN);

        public var inButton:NYCButton = new NYCButton(Button.IN);
        public var outButton:NYCButton = new NYCButton(Button.OUT);
        ...
        public static const TOPLEFT:Object = {
        	inButton: {top: '15px', right: '20px'},
        	outButton: {top: '40px', right: '20px'}
        };
        ...
        public function MTAMapControls(map:Map, keyboard:Boolean=true, fullScreen:Boolean=false, buttonPositions:Object=null)
        {
            this.map = map;
        ...
        private function onStageKeyboardEvent(event:KeyboardEvent):void
        {
        	...
        	if (buttonKeys[char]) {
        		...
        		if (event.type == KeyboardEvent.KEY_DOWN) {
	        		...
	        		if ((actions[buttons.indexOf(buttonKeys[event.keyCode])] as Function))
